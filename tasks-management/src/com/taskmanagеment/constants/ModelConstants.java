...
public class ModelConstants {
    ...
    public static final String MISSING_PERSON = "This member does not exists";
    ...
    public static final String CREATED_ITEM = "The working item %s has been crated successfully";
