...
public class CommandConstants {
    ...
    public static final String BOARD_NOT_EXISTS = "Board with name '%s' not exists!";
    public static final String MEMBER_ADDED_TO_TEAM_SUCCESSFULLY = "'%s' add to team '%s'!";
    public static final String BOARD_ADDED_TO_TEAM_SUCCESSFULLY = "Board with name '%s' add to team '%s'!";
    public final static String BOARD_REMOVED_SUCCESSFULLY = "Board with name '%s' removed successfully!";
