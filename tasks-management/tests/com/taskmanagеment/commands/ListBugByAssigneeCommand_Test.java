...
//        this.command = new ListBugByAssigneeCommand(taskManagementRepository);
//    }
//
//    @ParameterizedTest(name = "with arguments count: {0}")
//    @ValueSource(ints = {ListBugByAssigneeCommand.EXPECTED_NUMBER_OF_ARGUMENTS + 1, ListBugByAssigneeCommand.EXPECTED_NUMBER_OF_ARGUMENTS - 1})
