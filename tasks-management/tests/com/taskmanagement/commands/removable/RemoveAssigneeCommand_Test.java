...
import com.taskmanagement.commands.creation.removable.RemoveAssigneeCommand;
...
public class RemoveAssigneeCommand_Test {
    ...
    public void before() {
        ...
        this.command = new RemoveAssigneeCommand(taskManagementRepository);
    }


    @ParameterizedTest(name = "with arguments count: {0}")
    @ValueSource(ints = {RemoveAssigneeCommand.EXPECTED_NUMBER_OF_ARGUMENTS - 1, RemoveAssigneeCommand.EXPECTED_NUMBER_OF_ARGUMENTS + 1})
    ...
    public void execute_should_removeBoard_when_passedValidInput() {
       ...
       command.executeCommand(List.of(String.valueOf(bug.getId())));
        ...
        Assertions.assertEquals("", taskManagementRepository.getBugs().get(0).getAssignee());
