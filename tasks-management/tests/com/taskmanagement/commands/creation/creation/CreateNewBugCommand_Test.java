...
public class CreateNewBugCommand_Test {
    ...
    public void before() {
        ...
        this.command = new CreateNewBugCommand(taskManagementRepository);
        this.helperRepository = new TaskManagementHelperRepositoryImpl(taskManagementRepository);
    }

    @ParameterizedTest(name = "with arguments count: {0}")
    @ValueSource(ints = {CreateNewBugCommand.EXPECTED_NUMBER_OF_ARGUMENTS - 1, CreateNewBugCommand.EXPECTED_NUMBER_OF_ARGUMENTS + 1})
