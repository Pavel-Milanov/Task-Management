...
public class ShowActivityMemberCommand_Test {
    ...
    public void before() {
        ...
        this.command = new ShowActivityMemberCommand(taskManagementRepository);
        this.helperRepository = new TaskManagementHelperRepositoryImpl(taskManagementRepository);
    }

    @ParameterizedTest(name = "with arguments count: {0}")
    @ValueSource(ints = {ShowActivityMemberCommand.EXPECTED_NUMBER_OF_ARGUMENTS + 1})
