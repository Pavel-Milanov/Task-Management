...
public class ShowAllMembersCommand_Test {
    ...
    public void before() {
        ...
        this.command = new ShowAllMembersCommand(taskManagementRepository);
        this.helperRepository = new TaskManagementHelperRepositoryImpl(taskManagementRepository);
    }

    @ParameterizedTest(name = "with arguments count: {0}")
    @ValueSource(ints = {ShowAllMembersCommand.EXPECTED_NUMBER_OF_ARGUMENTS + 1})
