...
import com.taskmanagement.commands.creation.listing.ListAllTasksSortByTitle;
...
public class ListAllTasksSortByTitleCommand_Test {
    ...
    public void before() {
        ...
        this.command = new ListAllTasksSortByTitle(taskManagementRepository);
    }
